...
from datasets import build_dataset, get_coco_api_from_dataset, build_dataset_original
from engine_vis import evaluate, train_one_epoch
...
def main(args):
    ...
    dataset_val_original = build_dataset_original(image_set='val', args=args)
    ...
    if args.eval:
        ...
        results = evaluate(model, criterion, postprocessors,
                                              data_loader_val, base_ds, device, args.output_dir, dataset_val_original)
        
        
        dataset_val_original
